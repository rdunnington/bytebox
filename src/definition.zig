...
pub const InstructionImmediates = extern union {
    ...
    pub fn asAlignedBytes(immediates: InstructionImmediates, opcode: Opcode) AlignedBytes {
        const Helpers = struct {
            fn toBytes(immediates_: anytype) AlignedBytes {
                return .{
                    .bytes = @alignCast(std.mem.asBytes(immediates_)),
                    .alignment = @alignOf(@TypeOf(immediates_)),
                };
            }
        };

        return switch (opcode) {
            .Select_T => return Helpers.toBytes(&immediates.ValType),
            .Local_Get, .Local_Set, .Local_Tee, .Global_Get, .Global_Set, .Table_Get, .Table_Set => return Helpers.toBytes(&immediates.Index),
            .I32_Const => return Helpers.toBytes(&immediates.ValueI32),
            .I64_Const => return Helpers.toBytes(&immediates.ValueI64),
            .F32_Const => return Helpers.toBytes(&immediates.ValueF32),
            .F64_Const => return Helpers.toBytes(&immediates.ValueF64),
            .Block, .Loop => return Helpers.toBytes(&immediates.Block),
            .If => return Helpers.toBytes(&immediates.If),
            .IfNoElse => return Helpers.toBytes(&immediates.If),
            .Branch, .Branch_If => return Helpers.toBytes(&immediates.LabelId),
            .Branch_Table => return Helpers.toBytes(&immediates.Index),
            .Call => return Helpers.toBytes(&immediates.Index),
            .Call_Indirect => return Helpers.toBytes(&immediates.CallIndirect),
            .I32_Load,
            .I64_Load,
            .F32_Load,
            .F64_Load,
            ...
            .I64_Store16,
            .I64_Store32,
            => return Helpers.toBytes(&immediates.MemoryOffset),
            .Memory_Init => return Helpers.toBytes(&immediates.Index),
            .Ref_Null => return Helpers.toBytes(&immediates.ValType),
            .Ref_Func => return Helpers.toBytes(&immediates.Index),
            .Data_Drop => return Helpers.toBytes(&immediates.Index),
            .Table_Init, .Table_Copy => return Helpers.toBytes(&immediates.TablePair),
            .Elem_Drop, .Table_Grow, .Table_Size, .Table_Fill => return Helpers.toBytes(&immediates.Index),
            .V128_Load,
            .V128_Load8x8_S,
            .V128_Load8x8_U,
            .V128_Load16x4_S,
            ...
            .F64x2_Extract_Lane,
            .F64x2_Replace_Lane,
            => return Helpers.toBytes(&immediates.Index),
            .V128_Store => return Helpers.toBytes(&immediates.MemoryOffset),
            .V128_Const => return Helpers.toBytes(&immediates.ValueVec),
            .I8x16_Shuffle => return Helpers.toBytes(&immediates.VecShuffle16),
            .V128_Load8_Lane,
            .V128_Load16_Lane,
            .V128_Load32_Lane,
            .V128_Load64_Lane,
            ...
            .V128_Store32_Lane,
            .V128_Store64_Lane,
            => return Helpers.toBytes(&immediates.MemoryOffsetAndLane),
            .V128_Load32_Zero, .V128_Load64_Zero => return Helpers.toBytes(&immediates.MemoryOffset),
            else => unreachable,
        };
    }
};
